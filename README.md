...
Using a minimalist "Patagonia-inspired" aesthetic, the app transforms dense government documents into an interactive, topographic map experience.

##  What It Does
- **Real-Time Monitoring:** Fetches the latest filings from the Bureau of Land Management (BLM), Forest Service (USFS), and National Park Service (NPS).
- **AI-Powered Analysis:** Uses LLMs to parse legalese into plain English, determining the "Impact Level" and "Category" of each event.
- **Geospatial Visualization:** Maps specific policy coordinates onto an Esri Shaded Relief terrain map.
- **Protected Land Overlays:** Displays National Park boundaries (GeoJSON) to provide context for nearby industrial permits.
